...
//         $newFilePath5 = $path.$newFileName5;
//         $newFilePath6 = $path.$newFileName6;
//         $newFilePath7 = $path.$newFileName7;
...
//         move_uploaded_file($filePath_Temp5, $newFilePath5);
//         move_uploaded_file($filePath_Temp6, $newFilePath6);
//         move_uploaded_file($filePath_Temp7, $newFilePath7);
